...
if __name__ == "__main__":
    ...
    folder = 'ctEE_' + p.runNumber + fname + iterext + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
...
#    shutil.copyfile(stardir + '/' + 'fast_restack.py', retdir + '/fast_restack.py')
    ...
    if p.splitPhotons == True:
        htimep1, hlaserp1, fitdatap1, seedmapp1 = snf.fitTime(histListp1,transListp1,htimep1,hlaserp1,p.minStat,p.minNormal,p.includeSeedMap,p.manualHitCounterCut,"pp1_",p.graphs2printEE)
        htimem1, hlaserm1, fitdatam1, seedmapm1 = snf.fitTime(histListm1,transListm1,htimem1,hlaserm1,p.minStat,p.minNormal,p.includeSeedMap,p.manualHitCounterCut,"mp1_",p.graphs2printEE)
        htimep2, hlaserp2, fitdatap2, seedmapp2 = snf.fitTime(histListp2,transListp2,htimep2,hlaserp2,p.minStat,p.minNormal,p.includeSeedMap,p.manualHitCounterCut,"pp2_",p.graphs2printEE)
        htimem2, hlaserm2, fitdatam2, seedmapm2 = snf.fitTime(histListm2,transListm2,htimem2,hlaserm2,p.minStat,p.minNormal,p.includeSeedMap,p.manualHitCounterCut,"mp2_",p.graphs2printEE)
        ...
        htimep,hlaserp,fitdatap,seedmapp = snf.fitTime(histListp,transListp,htimep,hlaserp,p.minStat,p.minNormal,p.includeSeedMap,p.manualHitCounterCut,"pc_",p.graphs2printEE)
        htimem,hlaserm,fitdatam,seedmapm = snf.fitTime(histListm,transListm,htimem,hlaserm,p.minStat,p.minNormal,p.includeSeedMap,p.manualHitCounterCut,"mc_",p.graphs2printEE)
