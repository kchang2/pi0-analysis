...
#    shutil.copyfile(stardir + '/' + 'fast_restack.py', retdir + '/fast_Restack.py')
    ...
    if p.splitPhotons == True:
        htime1, hlaser1, fitdata1, seedmap1 = snf.fitTimeEta(histList1, transList1, htime1, hlaser1, p.minStat, p.minNormal, p.includeSeedMap, p.manualHitCounterCut, "p1_", p.graphs2print)
        htime2, hlaser2, fitdata2, seedmap2 = snf.fitTimeEta(histList2, transList2, htime2, hlaser2, p.minStat, p.minNormal, p.includeSeedMap, p.manualHitCounterCut, "p2_", p.graphs2print)
        ...
        htime, hlaser, fitdata, seedmap = snf.fitTimeEta(histList, transList, htime, hlaser, p.minStat, p.minNormal, p.includeSeedMap, p.manualHitCounterCut, "c_", p.graphs2print)
